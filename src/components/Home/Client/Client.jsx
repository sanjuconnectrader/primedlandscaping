...
function TestimonialCard({ name, headline, quote, rating, date, index }) {
  ...
  return (
    ...
    >
      ...
      <div className="testi-card__decorative-corner"></div>
      ...
      <div className="testi-card__header">
        ...
        <div className="testi-card__meta">
          <div>
            ...
            <p className="testi-card__date">{date}</p>
          </div>
      ...
      <div className="testi-card__footer">
        <svg className="testi-card__logo" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2L4 5v6.09c0 5.05 3.41 9.76 8 10.91 4.59-1.15 8-5.86 8-10.91V5l-8-3zm-1.06 13.54L7.4 12l1.41-1.41 2.12 2.12 4.24-4.24 1.41 1.41-5.64 5.66z" fill="var(--primary)"/>
        </svg>
